...
def re_ness_beta(beta_r,beta_l,g,ham_type,e):
    #Define the parameters
    print("Beta_l is ",beta_l,"Beta_r is ",beta_r)
    ...
    scipy.io.savemat(f'ness_data_NL1={NL1},NL2={NL2},NM={NM},e={e},beta_r={beta_r},beta_l={round(beta_l,3)},g={round(g,3)}_{ham_type}.mat',data_dict)
 

re_ness_beta(beta_r,beta_l,g,ham_type,e)
