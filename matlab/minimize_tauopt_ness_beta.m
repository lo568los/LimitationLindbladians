    ...
    for h1 = 1:length(h_list)
        ...
        for index1 = 1:length(betar_list)
            ...
            for index2 = 1:length(betal_list)
                load(sprintf("ness_data_NL1=2,NL2=2,NM=2,e=%.2f,beta_r=%.1f,beta_l=%.3f,g=0.0100_%d.mat",e,betar_list(index1),betal_list(index2),ham_type))
            ...
            save(sprintf("./data_plotting_vsbeta_4/diag_data_NL1=%d,e=%.2f,beta_r=%.1f,g=0.1000,ham_type=%d.mat",NL1,e,betar_list(index1),ham_type))
        end
    end
end