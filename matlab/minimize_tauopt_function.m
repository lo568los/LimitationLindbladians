...
function [output] = minimize_tauopt_function(NL1,NL2,NM,H_S,dm_ness1)
    ...
    cvx_begin sdp 
        ...
        %variable gamma_matrix2(dL2^2-1,dL2^2-1) hermitian semidefinite %declare Gamma2 to be PSD matrix. + create_L2_2(rho_th,H_S,H_LS2,gamma_matrix2,F2,NL2,NM + NL1)
    
        objfunc = 0;
    
        for i = 1:d
               objfunc = objfunc+ abs(V(:,i)'*(create_L2(rho_th,H_S,H_LS1,gamma_matrix1,F1,NL1,NM + NL2) )*V(:,i)) ;
        end
